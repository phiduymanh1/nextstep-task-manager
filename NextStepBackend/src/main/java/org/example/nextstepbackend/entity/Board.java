...
@Entity
@Table(name = "boards",
        uniqueConstraints = {@UniqueConstraint(name = "unique_board_slug", columnNames = {"workspace_id", "slug"})},
        indexes = {@Index(name = "idx_workspace_id", columnList = "workspace_id"), @Index(name = "idx_is_closed", columnList = "is_closed")})
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
